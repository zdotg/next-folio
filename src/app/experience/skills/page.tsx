...
export default function Skills() {
  return (
    <div
      className="flex min-h-screen py-8 justify-center bg-white text-slate-300"
      id="Skills"
    >
      <div className="max-w-3/4">
        <h2 className="text-center text-3xl text-white font-light py-2 ">
          Skills
        </h2>
        ...
        <div className="row  py-5 px-2 text-center border  text-slate-700 grid grid-cols-1 md:grid-cols-3 gap-4">
