export default function AcademicExperience() {
  return (
    <div className="flex items-start min-h-screen w-full ">
      ...
      <h2 className="text-center text-gradient text-2xl font-semibold pb-5">
        Academic Qualifications
      </h2>
      <table className="border-solid border-2 border-violet-500 bg-violet-100 dark:bg-violet-200 text-slate-500 dark:text-slate-700 mx-auto mt-10 py-0 content-start justify-start w-80 md:w-9/12">
      <thead>
        <tr >
